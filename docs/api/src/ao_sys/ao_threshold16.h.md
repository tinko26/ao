...
```c
bool ao_threshold16_wait     (ao_threshold16_wait_t * w, ao_time_t timeout);
bool ao_threshold16_wait_from(ao_threshold16_wait_t * w, ao_time_t timeout, ao_time_t beginning);
```
...
```c
bool ao_threshold16_wait_forever(ao_threshold16_wait_t * w);
```
...
```c
bool ao_threshold16_wait_try(ao_threshold16_wait_t * w);
```
